...
<head>
	...
	<style type="text/css">
		...
		.leftCol {
			background-image: url('images/ske.jpg');

		}
		.rightCol {
			background-image: url('images/ske2.jpg');
		}
		.obscure {
			margin-left: -15px;
			width: 110%;
				...
				<form class="form-group" method="post" action="login.php">
					<?php include('errors.php'); ?>
				  		<center>
					  	  ...
					  	  <input class="form-control textField" type="text" name="username">

					  
					  	  <label>Password</label>
					  	  <input class="form-control textField" type="password" name="password">
